# ==========================================
# Tabular-only XGBoost (params.yaml driven)
# ==========================================
...
TRAIN_PATH = DATA_DIR / "train_tabular.csv"
TEST_PATH = DATA_DIR / "test_tabular.csv"
OUTPUT_PATH = Path("Submission/predictions_tabular.csv")
...
print("\n📊 TABULAR XGBOOST VALIDATION METRICS")
print(f"MAE  : {mae:.4f}")
print(f"RMSE : {rmse:.4f}")
print(f"R2   : {r2:.4f}")

# ------------------------
# Save metrics (Tabular)
# ------------------------
metrics = {
    "model": "tabular",
    "mae": float(mae),
...
metrics_path = Path("Submission/metrics_tabular.json")
